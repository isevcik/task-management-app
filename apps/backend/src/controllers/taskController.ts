...
export const saveTask = (req: Request<object, object, TaskDTO>, res: Response): void => {
...
export const updateTask = (req: Request<{ id: string }, object, TaskDTO>, res: Response): void => {
    const taskId = req.params.id;
